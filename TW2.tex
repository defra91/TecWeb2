...
\include{abstract}		% capitolo 1
\include{6w}			% capitolo 2
\include{tempo}			% capitolo 3
\include{contenuto}		% capitolo 4
\include{pubblicita}	% capitolo 5
\include{ricerca}		% capitolo 6
\include{valutazione}	% capitolo 7
